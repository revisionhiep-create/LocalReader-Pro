"""
LocalReader Pro v3.4 - Self-Contained Installer
...
class InstallerGUI:
    def __init__(self, install_dir):
        ...
        self.root = tk.Tk()
        self.root.title("LocalReader Pro v3.4 - Setup")
        ...
        # UI Components
        tk.Label(
            self.root, text="LocalReader Pro v3.4", font=("Arial", 14, "bold")
        ).pack(pady=10)

        self.status_label = tk.Label(
            self.root, text="Ready to install", font=("Arial", 10)
        )
        ...
        self.log_text = tk.Text(
            self.root, height=6, width=60, state="disabled", font=("Consolas", 8)
        )
